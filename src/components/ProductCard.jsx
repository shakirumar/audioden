      ...
      <div className="flex flex-col flex-grow p-4">
        ...
        <div className="pt-2 border-t border-gray-100 mt-auto space-y-2">
          ...
          <button
            ...
            className="w-full text-left p-1.5 rounded-lg bg-gradient-to-r from-blue-50/80 via-amber-50/60 to-blue-50/80 hover:bg-amber-100/80 border border-amber-200/90 text-[10px] text-slate-900 font-bold flex items-center justify-between transition-colors cursor-pointer group/fin shadow-2xs"
            title="Click to view 0% Brand Finance & EMI Schemes"
          >
            <div className="flex items-center gap-1 min-w-0">
              <CreditCard className="w-3 h-3 text-amber-600 flex-shrink-0" />
              <span className="truncate">Brand Finance 0% EMI</span>
            </div>
            <span className="text-blue-700 font-black flex-shrink-0 group-hover/fin:underline text-[9.5px]">
